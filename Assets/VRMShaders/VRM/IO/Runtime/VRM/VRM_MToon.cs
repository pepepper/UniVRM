...
,new ShaderProperty("_Color_Mirror", ShaderPropertyType.Color)
,new ShaderProperty("_ShadeColor", ShaderPropertyType.Color)
,new ShaderProperty("_ShadeColor_Mirror", ShaderPropertyType.Color)
,new ShaderProperty("_MainTex", ShaderPropertyType.TexEnv)
,new ShaderProperty("_MainTex_Mirror", ShaderPropertyType.TexEnv)
,new ShaderProperty("_ShadeTexture", ShaderPropertyType.TexEnv)
,new ShaderProperty("_ShadeTexture_Mirror", ShaderPropertyType.TexEnv)
...
,new ShaderProperty("_EmissionColor_Mirror", ShaderPropertyType.Color)
,new ShaderProperty("_EmissionMap", ShaderPropertyType.TexEnv)
,new ShaderProperty("_EmissionMap_Mirror", ShaderPropertyType.TexEnv)
